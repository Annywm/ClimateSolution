...
- ${Exudate}_N = \frac{C_e}{0.45} \times \frac{N_e}{1000}$
     ...
     **Variables**:
      ...
      - $N_e$: Nitrogen concentration in the extraroo (kg N/kg)
...
### $N_{CropResidues}$
$$
N_{CropResidues} = ([\frac{C_{p\_to\_soil}}{0.45} \times N_p+ \frac{C_s}{0.45} \times N_s] + BelowGround_{residue\_N}) \times {area}
$$ 

\frac{C_{p\_to\_soil}}{0.45} \times \frac{N_p}{1000}
### Crop Related formula
