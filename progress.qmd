...
In addition, I will research a bit on the current economic models that could incorporate emissions measurement to quantify economic costs and benefits, which are likely to be at the heart of the trade-off farmers would face. This is not going to be a primary focus at the moment, but it would be useful (IMO at the moment, but would be useful (imo) to have a dollar value paired with emissions.  
